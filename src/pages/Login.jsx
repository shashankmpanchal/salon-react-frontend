    ...
    <div className="flex min-h-screen">
      <div className="hidden w-1/2 bg-gradient-to-br from-salon-800 via-salon-700 to-salon-900 lg:flex lg:flex-col lg:justify-center lg:px-16">
        ...
        <p className="mt-4 max-w-md text-lg text-salon-200">
          Book your perfect salon experience. Choose your stylist, pick a time, and relax.
        </p>
      </div>

      <div className="flex w-full flex-col justify-center px-6 py-12 lg:w-1/2 lg:px-16">
        <div className="mx-auto w-full max-w-md">
          <h2 className="font-display text-3xl font-bold text-salon-900">Welcome back</h2>
          <p className="mt-2 text-salon-600">Sign in to manage your appointments</p>

          <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-5" noValidate>
            {error && <Alert type="error" message={error} onClose={() => dispatch(clearAuthError())} />}
          ...
          <p className="mt-6 text-center text-sm text-salon-600">
            ...
            <Link to={ROUTES.REGISTER} className="font-medium text-salon-700 hover:text-salon-900">
              Register
            </Link>
          </p>
